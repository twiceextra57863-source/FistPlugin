...
public class BlossomFist extends BaseAbility {
    ...
    public boolean onRightClick(Player player) {
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                loc.getWorld().spawnParticle(Particle.HAPPY_VILLAGER, loc, 2, 0.1, 0.1, 0.1, 0);
                loc.getWorld().spawnParticle(Particle.END_ROD, loc, 1, 0.1, 0.1, 0.1, 0);
            }
    ...
    public boolean onCrouchRightClick(Player player) {
        ...
        // Freeze and poison
        target.setFreezeTicks(200); // 10 seconds
        ...
        new BukkitRunnable() {
            ...
            public void run() {
                ...
                for (int i = 0; i < 360; i += 45) {
                    ...
                    target.getWorld().spawnParticle(Particle.SPELL_MOB, spiral, 1, 0, 0, 0, 0);
                }
                
                damageTicks++;
            }
        }.runTaskTimer(plugin, 20L, 20L); // Every second for 10 seconds
